  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:image" content="https://www.yoursite.com/images/booking-banner.jpg" />
        ...
        {isConfirmed && (
          <form className="bg-white shadow-md rounded-lg p-6 w-full max-w-md" onSubmit={handleBooking}>
            ...
            <button
              type="submit"
              className={`w-full ${
                isSlotBooked ? "bg-gray-400 cursor-not-allowed" : "bg-blue-500"
              } text-white font-bold py-2 px-4 rounded-lg`}
              disabled={isSlotBooked}
            >
              {isSlotBooked ? "Slot Sudah Dipesan" : "Book Now"}
            </button>
          </form>
        )}
