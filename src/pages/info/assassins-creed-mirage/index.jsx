  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Jelajahi Assassin's Creed Mirage di Filkom Game Corner UB! Temukan gameplay mendalam, sinopsis, dan lebih banyak lagi tentang game aksi-petualangan yang berlatar belakang di Baghdad abad ke-9."
        />
        <meta
          name="keywords"
          content="Assassin's Creed Mirage, Filkom UB Game Corner, UB, game, video game, game petualangan, game aksi, PS5, Xbox, RPG, open world, stealth"
        />
