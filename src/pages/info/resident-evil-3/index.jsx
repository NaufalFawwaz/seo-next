  ...
  return (
    <div className="flex flex-col items-center py-7">
      ...
      <button
        ...
        onClick={() => window.open("https://youtu.be/xNjGFUaorYc?si=jA7nTyCljktomtp5", "_blank")}
      >
      ...
      <div className="flex flex-col md:flex-row items-start justify-between w-full xl:px-40 px-10 gap-10">
        <div className="text-left flex-1 bg-gray-50 rounded-lg p-6 shadow-lg">
          ...
          <p className="text-lg xl:text-xl mb-8 max-w-[700px] xl:max-w-[800px] text-gray-700 leading-relaxed">
            <span className="font-medium">*Resident Evil 3*</span> adalah remake dari game survival horror klasik
            yang membawa pemain kembali ke Raccoon City, kali ini dengan ancaman yang lebih besar dan musuh
            yang lebih mematikan. Dengan grafis yang ditingkatkan dan gameplay yang diperbarui, game ini menawarkan
          ...
          <p className="text-lg xl:text-xl max-w-[700px] xl:max-w-[800px] text-gray-700 leading-relaxed">
            Dalam <span className="font-medium">*Resident Evil 3*</span>, pemain mengikuti kisah Jill Valentine,
            yang berjuang untuk bertahan hidup melawan Nemesis, makhluk yang diciptakan untuk menghancurkan semua
            anggota S.T.A.R.S. Pemain harus melarikan diri dari kota yang terinfeksi, sambil mengungkap rahasia
